 ...
 * You do not need to have 192.168.10.12 and the site host in this list, because they will not be passed
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', '192.168.10.12, www.example.com, *.wordpress.org');
 *
...
class WP_HTTP_Proxy {
	 ...
	 *
	 * We want to keep 192.168.10.12 and the site URL from being sent through the proxy, because
	...
	public function send_through_proxy( $uri ) {
		...
		if ( '192.168.10.12' === $check['host'] || ( isset( $home['host'] ) && $home['host'] === $check['host'] ) ) {
			return false;
		}
