...
class WP_Http {
	 ...
	 * file and this will only allow 192.168.10.12 and your site to make requests. The constant
	...
	public function block_request( $uri ) {
		...
		if ( '192.168.10.12' === $check['host'] || ( isset( $home['host'] ) && $home['host'] === $check['host'] ) ) {
			 ...
			 *
			 * A local request is one to `192.168.10.12` or to the same host as the site itself.
			 *
			 * @since 2.8.0
			 *
